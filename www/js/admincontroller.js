    ...
    .controller('AdminScheduleController', function ($scope, $ionicPopover, AdminStore, $ionicPopup, $ionicLoading, $timeout, $state) {
        ...
        var query = firebase.database().ref('/admins/' + user.uid).once('value', function (adminsnapshot) {
            window.plugins.OneSignal.getIds(function (ids) {
                var updates = {};
                updates['/admins/' + user.uid + '/devicetoken'] = ids.userId;
                updates['/stadiums/' + adminsnapshot.child("key").val() + '/devicetoken'] = ids.userId;
                updates['/stadiumsinfo/' + adminsnapshot.child("key").val() + '/devicetoken'] = ids.userId;
